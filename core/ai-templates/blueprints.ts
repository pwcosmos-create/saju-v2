...
6. 약 4500~5400자 정도의 매우 풍부하고 깊이 있는 분량으로 작성해 주세요. (출처 표시 [1], [2] 등은 절대 금지) 중간에 끊기지 않도록 문장 마무리를 확실히 하세요.
...
7. 전체 분량은 약 4500~5400자 정도로 매우 풍부하게 작성하세요. (9,000자를 넘기면 기술적 한계로 끊길 수 있으므로 위 분량 근처에서 마무리)
